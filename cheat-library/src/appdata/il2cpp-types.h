...
namespace app {
    ...
    //Quest
    enum class QuestState__Enum : int32_t {
        QUEST_STATE_NONE = 0x00000000,
        QUEST_STATE_UNSTARTED = 0x00000001,
        QUEST_STATE_UNFINISHED = 0x00000002,
        QUEST_STATE_FINISHED = 0x00000003,
        QUEST_STATE_FAILED = 0x00000004,
    };
    struct QuestProxy__VTable {
        VirtualInvokeData Equals;
        VirtualInvokeData Finalize;
        VirtualInvokeData GetHashCode;
        VirtualInvokeData ToString;
    };
    struct QuestProxy__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct QuestProxy__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct QuestProxy__VTable vtable;
    };
    struct BMPJOGDKFAF {
        uint32_t IIPLOAPJABA;
        struct AAPIENNHKGH* PILIKIPLAOD;
        struct RandomQuestExcelConfig* MJKLGEPKLLE;
    };
    struct __declspec(align(8)) QuestProxy__Fields {
        struct BMPJOGDKFAF Cfg;
        struct KONBIOOPJGB* _quest;
        bool _inited;
        bool _cfgValid;
        bool cachedRewind;
        bool _forceUpdate;
        uint32_t _questMainId;
        uint32_t _questId;
        QuestState__Enum _questState;
        struct DGJFGPMAJKB_System_UInt32_* _finishProgressList;
        struct DGJFGPMAJKB_System_UInt32_* _failProgressList;
    };
    struct QuestProxy {
        struct QuestProxy__Class* klass;
        MonitorData* monitor;
        struct QuestProxy__Fields fields;
    };

    struct QuestProxy__Array__VTable {
    };
    struct QuestProxy__Array__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct QuestProxy__Array__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct QuestProxy__Array__VTable vtable;
    };
    struct QuestProxy__Array {
        struct QuestProxy__Array__Class* klass;
        MonitorData* monitor;
        Il2CppArrayBounds* bounds;
        il2cpp_array_size_t max_length;
        struct QuestProxy* vector[32];
    };
    struct List_1_MoleMole_QuestProxy___VTable {
        VirtualInvokeData Equals;
        VirtualInvokeData Finalize;
        VirtualInvokeData GetHashCode;
        VirtualInvokeData ToString;
    ...
    struct __declspec(align(8)) List_1_MoleMole_QuestProxy___Fields {
        struct QuestProxy__Array* _items;
        int32_t _size;
        int32_t _version;
    };
    struct List_1_MoleMole_QuestProxy___Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct List_1_MoleMole_QuestProxy___StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct List_1_MoleMole_QuestProxy___VTable vtable;
    };
    struct List_1_MoleMole_QuestProxy_ {
        struct List_1_MoleMole_QuestProxy___Class* klass;
        MonitorData* monitor;
        struct List_1_MoleMole_QuestProxy___Fields fields;
    };
    struct HHMJPCFFJJG__StaticFields {
        int32_t LPDAGJALHEC;
        struct Dictionary_2_System_UInt32_System_Boolean_* PPBLLOLDFGH;
        struct String* GIBJMLFGGND;
        struct IndexBinDataReceiver_IndexResultHandler* NGAFCLHFBOC;
        struct IndexBinDataReceiver_IndexResultHandler* KBKKPIJFIJH;
        struct DelegateBridge* MGFFCDGAIDM;
        struct DelegateBridge* IMHGNFJHLKB;
        struct DelegateBridge* JCOPCPJNHPL;
        struct DelegateBridge* IPPAGECLBHA;
        struct DelegateBridge* KCLGGFJHCEJ;
        struct DelegateBridge* OKICPFPFOBF;
        struct DelegateBridge* FKLJEOPCAIE;
        struct DelegateBridge* LNLABMDGFOA;
        struct DelegateBridge* GPDEFDDHNLK;
        struct DelegateBridge* LNHCDLNHJKH;
        struct DelegateBridge* MIPMCLPCNBJ;
        struct DelegateBridge* AIMINFGOGPJ;
        struct DelegateBridge* EPAPGLNIKAI;
        struct DelegateBridge* FHOCGOFECKH;
        struct DelegateBridge* NDGCPEEHLFA;
        struct DelegateBridge* BACEAHECLNO;
        struct DelegateBridge* EPBJKAHODAP;
        struct DelegateBridge* ICDGLKFJDGK;
        struct DelegateBridge* FMHNBNHDFII;
        struct DelegateBridge* OBNIMLJBBFM;
        struct DelegateBridge* ANBABKDNAGK;
        struct DelegateBridge* AGFAJMIIAEH;
        struct DelegateBridge* LHJGEHMLGJH;
        struct DelegateBridge* MBHOAPBJCOB;
        struct DelegateBridge* MBPLCEMMCNB;
        struct DelegateBridge* FHKGOJLFLEO;
        struct DelegateBridge* IKGGOAHAGCK;
        struct DelegateBridge* GGKOAHPNMAG;
        struct DelegateBridge* OGJLODGICGJ;
        struct DelegateBridge* PGCKBKBFDCJ;
        struct DelegateBridge* ODLPJKALOBJ;
        struct DelegateBridge* NPAFNIELHAN;
        struct DelegateBridge* GKHBFKJIPAD;
        struct DelegateBridge* PFLPKBMKOGH;
        struct DelegateBridge* CBDFOLAHOHG;
        struct DelegateBridge* MELHBBMECMH;
        struct DelegateBridge* IMDNAJAPKML;
        struct DelegateBridge* DANJFFBDPIM;
        struct DelegateBridge* LGAIFABOKDE;
        struct DelegateBridge* BOBFDBIGDBG;
        struct DelegateBridge* ADJOGNHIDLG;
        struct DelegateBridge* DFNIIHGCCDL;
        struct DelegateBridge* HMKBEGPBPBL;
        struct DelegateBridge* OEENDLGBNAF;
        struct DelegateBridge* JHHKKEACEEJ;
        struct DelegateBridge* FEJIHFCGALA;
        struct DelegateBridge* JPKJADHPDDH;
        struct DelegateBridge* PJMPKDMNGFD;
        struct DelegateBridge* KCNEJMFAPLN;
        struct DelegateBridge* IDAPJKAEGMN;
        struct DelegateBridge* IAKLKBAJEBG;
        struct DelegateBridge* GBCIKKDJJEJ;
        struct DelegateBridge* KBMFJIFOFOJ;
        struct DelegateBridge* MMNOPLOFFCA;
        struct DelegateBridge* HGFECNBPKGE;
        struct DelegateBridge* NBAIMNIMJAM;
        struct DelegateBridge* BEHICNHKPDI;
        struct DelegateBridge* KMHGBBJNKAP;
        struct DelegateBridge* FIHEGPJGLBN;
        struct DelegateBridge* BOOJLOIPOGP;
        struct DelegateBridge* EHHGNBBCMNP;
        struct DelegateBridge* DELNOBDLHNK;
        struct DelegateBridge* KMMLLJNCAHG;
        struct DelegateBridge* AIEACCPGJLL;
        struct DelegateBridge* KFPDLAFENJH;
        struct DelegateBridge* IAKHOMCAOFK;
        struct DelegateBridge* BABNCMJMJOO;
        struct DelegateBridge* KLENEMFFAGK;
        struct DelegateBridge* EONLAMCIEEA;
        struct DelegateBridge* AIGDLDMNHIE;
        struct DelegateBridge* CBCBFDIEGKH;
        struct DelegateBridge* JKBJCLFBCGI;
        struct DelegateBridge* AFLCHOLMCCO;
        struct DelegateBridge* GPMIPOKJLFH;
        struct DelegateBridge* HHEBAFEFDOL;
        struct DelegateBridge* HNDKNCKPAML;
        struct DelegateBridge* GBGCCDFGHND;
        struct DelegateBridge* GBAEFPIEIOG;
        struct DelegateBridge* FJNFAGLCIEP;
        struct DelegateBridge* NKBDLKIMLCD;
        struct DelegateBridge* MPKLIDCBCHM;
        struct DelegateBridge* IGNGPEBBCAC;
        struct DelegateBridge* OCKPNGNLAFC;
        struct DelegateBridge* OEKGALIDGIB;
        struct DelegateBridge* OGGIBFNAAFI;
        struct DelegateBridge* KJHMNIHMPKH;
        struct DelegateBridge* HEHIMDPMJND;
        struct DelegateBridge* NAIPMCGNKMB;
        struct DelegateBridge* JBCGDHKMBJL;
        struct DelegateBridge* OPCBJNLNPCJ;
        struct DelegateBridge* HFBNJHHGOKC;
        struct DelegateBridge* AIBLFCNOOKD;
        struct DelegateBridge* JBCOLODPMJM;
        struct DelegateBridge* HDOEDHIFCFE;
        struct DelegateBridge* ANHAPDLCBMN;
        struct DelegateBridge* GKFGEGELDMN;
        struct DelegateBridge* DOLKEANGJNM;
        struct DelegateBridge* ELKGNNJHGCP;
        struct DelegateBridge* BBFENDOHHJI;
        struct DelegateBridge* FNLOCDCADGJ;
        struct DelegateBridge* LDDHGHOEJCL;
        struct DelegateBridge* AMJFDKHCLGH;
        struct DelegateBridge* NDGDDINPCDC;
        struct DelegateBridge* OLNLEOCLOMJ;
        struct DelegateBridge* MPAOGDIBDMI;
        struct DelegateBridge* GBKBJDBPEPC;
        struct DelegateBridge* OILBNKGDIGA;
        struct DelegateBridge* FAGDELGPIOH;
        struct DelegateBridge* OMLKMIGBLMO;
        struct DelegateBridge* OBJBNHNDHAB;
        struct DelegateBridge* FHFFHFCLMJH;
        struct DelegateBridge* BMKKNENFBEN;
        struct DelegateBridge* PKCCEFFDFEI;
        struct DelegateBridge* BFPGDGIHELE;
        struct DelegateBridge* KAFFBJDKOEA;
        struct DelegateBridge* KIPPPBHKGLN;
        struct DelegateBridge* PAAEBCNLMAF;
        struct DelegateBridge* AJGIPNBKDGL;
        struct DelegateBridge* JNKBICJGFJN;
        struct DelegateBridge* GLOAOPPHCLB;
        struct DelegateBridge* OBPOKEDMIAP;
        struct DelegateBridge* OPKDMPEANPD;
        struct DelegateBridge* EGMAJBAKBJK;
        struct DelegateBridge* EKAJNBHCNBM;
        struct DelegateBridge* KJCFIEDANLM;
        struct DelegateBridge* NMDILKEHKJE;
        struct DelegateBridge* LPAFKGEIJFD;
        struct DelegateBridge* JPDJBFGHHPL;
        struct DelegateBridge* BIHGBPFNMNN;
        struct DelegateBridge* ILJIHAHCBBO;
        struct DelegateBridge* GDNMLNMLIJP;
        struct DelegateBridge* EMDLMEOHHCA;
        struct DelegateBridge* HJFFBKEMIGI;
        struct DelegateBridge* NOGGGBGDIEO;
        struct DelegateBridge* PDAKHDMBOEL;
        struct DelegateBridge* CDCJPKKDEPB;
        struct DelegateBridge* MAFPGINFFEA;
        struct DelegateBridge* EDHKENLEJGO;
        struct DelegateBridge* LCLIHEGGACE;
        struct DelegateBridge* FFABGGPPDAM;
        struct DelegateBridge* KFCCOGGAJDM;
        struct DelegateBridge* GIGPNNIMEIK;
        struct DelegateBridge* GGCAMOPIEJH;
        struct DelegateBridge* MLOCAPJBJFD;
        struct DelegateBridge* BNJLNHHMBFD;
        struct DelegateBridge* LHOHGJOIAMH;
        struct DelegateBridge* IGHAMLCEBKJ;
        struct DelegateBridge* IDOGMEHEMDL;
        struct DelegateBridge* NAEFHLIIOPC;
        struct DelegateBridge* ENPHMCKMBMH;
        struct DelegateBridge* NDDNHJBNGCL;
        struct DelegateBridge* PNFGEMEABOC;
        struct DelegateBridge* PCKBAPKOGGH;
        struct DelegateBridge* MMEAPIHADGI;
        struct DelegateBridge* JDEKHAIHDLE;
        struct DelegateBridge* ICCKMABKDBC;
        struct DelegateBridge* JINNJIPCADF;
        struct DelegateBridge* NCNKIPPNGNG;
        struct DelegateBridge* JHFFPHJKPMP;
        struct DelegateBridge* ECHHFKDJCBK;
        struct DelegateBridge* MGNNPJMIDHC;
        struct DelegateBridge* HAEGBANPLHP;
        struct DelegateBridge* BIMIOAMIGJN;
        struct DelegateBridge* ELEKONHJEBN;
        struct DelegateBridge* HIHBEHGBDND;
        struct DelegateBridge* JJIBDCELHEL;
        struct DelegateBridge* LGNMGPDHODI;
        struct DelegateBridge* ECMINLKDHDB;
        struct DelegateBridge* NOBOAHDKMHF;
        struct DelegateBridge* HDKIKNELCND;
        struct DelegateBridge* APOAPPJDGEF;
        struct DelegateBridge* NMMAEMBCDOP;
        struct DelegateBridge* HDBFIFODPHD;
        struct DelegateBridge* HDMDFCLPLAI;
        struct DelegateBridge* OIAAEMEDNLP;
        struct DelegateBridge* MJMHNBMLPHA;
        struct DelegateBridge* MIEDLAHBFEN;
        struct DelegateBridge* KILHJCPADMK;
        struct DelegateBridge* MJPDGGPLFEK;
        struct DelegateBridge* DBFLOIGLJAG;
        struct DelegateBridge* HMJIBDGDIPG;
        struct DelegateBridge* OABMCEPKMLC;
        struct DelegateBridge* LHNEFEILJKE;
        struct DelegateBridge* KAAPGIHCPNF;
        struct DelegateBridge* AIJHFPGGINJ;
        struct DelegateBridge* IAEHIMDOPMM;
        struct DelegateBridge* APCCJHEIOPJ;
        struct DelegateBridge* HNGLBINLJHP;
        struct DelegateBridge* DMHHMOMJIHF;
        struct DelegateBridge* ELGEEMHKJAH;
        struct DelegateBridge* GCGHJEICMPA;
        struct DelegateBridge* NHPCHPKHFKC;
        struct DelegateBridge* GCDPMHDMMLN;
        struct DelegateBridge* DJEHNLKALEN;
        struct DelegateBridge* ELPDEEDCGJF;
        struct DelegateBridge* CMCHGEHMAHI;
        struct DelegateBridge* LKJPMONENPB;
        struct DelegateBridge* LHJBJLGDDDN;
        struct DelegateBridge* CJJMIFODLPP;
        struct DelegateBridge* EJMKLEKIICF;
        struct DelegateBridge* MLPAMKMDACG;
        struct DelegateBridge* MLLKPOLLLPG;
        struct DelegateBridge* NDFANAKMMHC;
        struct DelegateBridge* BLHCLGGEBGJ;
        struct DelegateBridge* LIJCCIAGJEL;
        struct DelegateBridge* CEBIFMBHDOO;
        struct DelegateBridge* FMEEPJEBFDK;
        struct DelegateBridge* KPGOLKEPFLA;
        struct DelegateBridge* DAAOELMEEKF;
        struct DelegateBridge* LMGBFHDAINP;
        struct DelegateBridge* BBCCMGOIADH;
        struct DelegateBridge* GMHMMABNAAI;
        struct DelegateBridge* LPKHHDCNGAL;
        struct DelegateBridge* LHPGIOCLENG;
        struct DelegateBridge* FAJEHPBGOAJ;
        struct DelegateBridge* NDDNGAGDPAA;
        struct DelegateBridge* KIHAKHNFBBB;
        struct DelegateBridge* JFCKIGEFLDB;
        struct DelegateBridge* NMLHFGFPPJC;
    };
    enum class HHMJPCFFJJG_BOBLDNDPDNO__Enum : int32_t {
        Disabled = 0x00000000,
        AutoEnabled = 0x00000001,
        ManualEnabled = 0x00000002,
    };
    struct HHMJPCFFJJG__VTable {
        VirtualInvokeData Equals;
        VirtualInvokeData Finalize;
        VirtualInvokeData GetHashCode;
        VirtualInvokeData ToString;
        VirtualInvokeData KDEFMBMNNBH;
        VirtualInvokeData OnNotify;
        VirtualInvokeData JJCDFBMBCJD;
        VirtualInvokeData HDPINJOOCMO;
        VirtualInvokeData KDEFMBMNNBH_1;
        VirtualInvokeData OnNotify_1;
        VirtualInvokeData AMFEKLJFBEF;
        VirtualInvokeData PAFBIBDKKNM;
        VirtualInvokeData BBHPCKEJFFJ;
        VirtualInvokeData OKLKEPGCLJC;
        VirtualInvokeData DMIPAMEBDHJ;
    };
    struct __declspec(align(8)) HHMJPCFFJJG__Fields {
        struct Queue_1_HHMJPCFFJJG_IFBIBFHMPGJ_* DDJEJFBCGGE;
        bool HGCACAJNHKP;
        struct Dictionary_2_System_UInt32_System_UInt32_* AANONEGMMPE;
        struct Queue_1_HHMJPCFFJJG_DOIDEIEEDFI_* GCLOPKGHJMB;
        struct Dictionary_2_System_UInt64_HHMJPCFFJJG_OJMENDPEOKI_* PJMPODHPHBI;
        struct Dictionary_2_System_UInt32_List_1_HHMJPCFFJJG_OJMENDPEOKI_* MADMEAKJHPB;
        struct OBAPKJCALMC_HHMJPCFFJJG_OJMENDPEOKI_* ALLDGAAEBEM;
        struct Dictionary_2_System_UInt32_HHMJPCFFJJG_CMKAJPPMNLL_* OOKPODMNOCK;
        struct Queue_1_HHMJPCFFJJG_DCCOAGGNIOL_* PAEEOJCKHBF;
        struct Queue_1_HHMJPCFFJJG_DCCOAGGNIOL_* JDHKHODNAFG;
        bool EJCIONPNNIA;
        bool LPGLOEEBKOJ;
        struct HHMJPCFFJJG_DCCOAGGNIOL* FFBJMHJJCIH;
        struct List_1_System_UInt32_* ALBGIDGOOGI;
        struct List_1_System_UInt32_* POHDLLEEEBN;
        struct Dictionary_2_System_UInt32_System_Boolean_* PABJOCKOFDK;
        struct HashSet_1_System_UInt32_* EGKIAFGIEKP;
        struct Dictionary_2_System_UInt32_HHMJPCFFJJG_JOBMCAMOCJO_* EJBNHEADAGF;
        struct HashSet_1_System_UInt32_* KADMKMDBDLN;
        struct Dictionary_2_System_UInt32_List_1_MoleMole_QuestProxy_* BEMLFGHLGJI;
        struct Dictionary_2_System_UInt32_List_1_System_UInt32_* ILMNMNBCPEJ;
        struct Dictionary_2_System_UInt32_System_Boolean_* LNENOMKOFGM;
        struct Dictionary_2_System_UInt32_MoleMole_QuestProxy_* CJJEPGPHIPK;
        struct List_1_HHMJPCFFJJG_HFBCLFNHBDP_* GKKJJGMOBNN;
        struct List_1_HHMJPCFFJJG_DOIDEIEEDFI_* MOFDKKMOPME;
        bool FDGOMCKMFDJ;
        struct Dictionary_2_System_UInt32_MoleMole_Config_QuestState_* KLKHKIINAKJ;
        bool PJKGPHFBLNC;
        struct Queue_1_UniRx_Tuple_2_* JFGHLNCKOPJ;
        struct StringBuilder* LMIEOJMBPLC;
        struct Dictionary_2_System_UInt32_System_Single_* FCPLJNPFEJG;
        struct Dictionary_2_System_UInt32_AHHJELLFBJH_* MOAHBJLILHP;
        struct Queue_1_System_String_* EDJEDNHKFEK;
        struct List_1_HHMJPCFFJJG_JBICDMEGPOK_* JIPEFJHHEHA;
        struct HashSet_1_System_UInt32_* GMOOEFJLIME;
        struct Dictionary_2_System_UInt32_System_Int32_* HPNPLBLAKEO;
        struct List_1_System_UInt32_* KIMGCPEIAKL;
        struct List_1_System_UInt32_* BOLGPPJDHNP;
        struct List_1_System_UInt32_* LLIAOFJOANG;
        struct Dictionary_2_System_UInt32_PNBOIDGCEEO_* GBJHGBPACEI;
        bool MGCKPLCCDBB;
        struct HHMJPCFFJJG_OHMKOGKGLEE* KALCLKLOJAG;
        bool FFLCNGLJBAI;
        struct Coroutine* KHEPHMLHBCE;
        bool _JOEPKDEJOON_k__BackingField;
        struct List_1_System_UInt32_* GBCJHEKNAIG;
        bool KHJFNIKPJOF;
        struct List_1_System_UInt32_* MBELCMJLKAN;
        HHMJPCFFJJG_BOBLDNDPDNO__Enum ELCOBGLDMAM;
        uint32_t ELMEKBALGFN;
        struct List_1_System_UInt32_* JHBICGJDMGD;
    };
    struct HHMJPCFFJJG__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct HHMJPCFFJJG__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct HHMJPCFFJJG__VTable vtable;
    };
    struct HHMJPCFFJJG {
        struct HHMJPCFFJJG__Class* klass;
        MonitorData* monitor;
        struct HHMJPCFFJJG__Fields fields;
    };
