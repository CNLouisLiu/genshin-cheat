...
DO_TYPEDEF(0x0B224E28, Byte);
DO_TYPEDEF(0x0B3117B8, GameManager);
DO_TYPEDEF(0x0B38FF20, Int32);

// v 2.6
DO_TYPEDEF(0x0B39D338, LCChestPlugin);
DO_TYPEDEF(0x0B2BC988, SceneTreeObject);

DO_SINGLETONEDEF(0x0B3442D8, Singleton_1_MBHLOBDPKEC_);
...
DO_SINGLETONEDEF(0x0B2F8038, Singleton_1_UIManager_1_);
